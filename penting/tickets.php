...
if (isset($_GET['datos'])){
    ...
    foreach ($data as $item) {
        echo '
                ...
                <tbody>         
                    <tr>             
                        <td style="text-align: center; color: #2F38F4; font-size: 13px; border-bottom: 1px #ccc solid;"><b>VOLCANO SM</b></td>        
                    </tr>          
                    <tr>              
                        <td>                   
                    ...
                    <tr>                   
                        <td style="text-align: center; font-size:11px;">Mas tickets en colcanosm.net</td>             
                        </tr>      
                    </tbody>     
            </table>
             ';
